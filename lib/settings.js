...
exports.port = safeGet('port') || 3001;

// The url the API will be accessed from
// do not provide default to allow dynamic endpoint resolution on request
exports.endpoint = safeGet('endpoint');

// logo
exports.logo = safeGet('logo') || '/images/logo.svg';
...
exports.nethash_units = safeGet('nethash_units') || ''; // default to auto scaling displayed value
